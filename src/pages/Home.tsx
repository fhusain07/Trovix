...
const differentiators = [
  ...
  },
  {
    ...
    description: "We don't disappear after delivery. Ongoing maintenance and WhatsApp-accessible support included.",
  },
];
...
const services = [
  {
    ...
    description: 'Custom CRM systems that replace spreadsheets — lead tracking, sales pipelines, and client management built for your workflow.',
    icon: Users,
  },
  {
            ...
            {services.map((service, index) => (
              <AnimatedSection key={index} delay={index * 0.1}>
                <GlassCard className="h-full">
                  ...
                  <Link to="/services" className="text-electric-blue hover:underline cursor-pointer inline-flex items-center text-sm">
